...
switch ($method) {
    case "POST":
        ...
        // Check if login (email and password only)
            ...
            if ($row = $result->fetch_assoc()) {
                ...
                if ($userData->password === $row['password']) {
                    ...
                    echo json_encode([
                        ...
                        "username" => $_SESSION['username'], // Include username
                        "address" => $_SESSION['address'] // Include address
                    ]);
                } else {
    ...
    case "GET":
        ...
        if (isset($_SESSION['user_id'])) {
            echo json_encode([
                ...
                "user_email" => $_SESSION['user_email'],
                "user_role" => $_SESSION['user_role'],
                "username" => $_SESSION['username'], // Include username in session response
                "address" => $_SESSION['address'] // Include address in session response
            ]);
        } else {
