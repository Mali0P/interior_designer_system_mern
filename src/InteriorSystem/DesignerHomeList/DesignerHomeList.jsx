...
let names = ["Pranesh Mali","Manish Adhikari","Sanjay Puri","Pramish Thoki"]
  return (
...
<div className="topHeading mb-[1vw] flex justify-between items-end pr-[1vw]">
            ...
            <h2 className='text-[2.5vw] font-[400] '>Meet Our Team</h2>
            </div>
...
<h3 className='text-[1.5vw] font-[600] mt-[0.6vw] absolute text-[white] '>{names[id]} <br />
